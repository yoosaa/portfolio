...
import type { StudioTransform } from "../../model/studio-layout.types";
...
export function Bookshelf({
  ...
  return (
    ...
    >
      <Box position={[0, 1.55, -0.36]} scale={[2.02, 2.98, 0.12]} color="#70927f" radius={0.05} />
      <Box position={[-1.02, 1.55, 0]} scale={[0.2, 3.12, 0.84]} color="#5f806f" radius={0.05} />
      <Box position={[1.02, 1.55, 0]} scale={[0.2, 3.12, 0.84]} color="#5f806f" radius={0.05} />
      <Box position={[0, 3.06, 0]} scale={[2.22, 0.2, 0.84]} color="#557463" radius={0.05} />
      <Box position={[0, 0.08, 0]} scale={[2.22, 0.2, 0.84]} color="#557463" radius={0.05} />
      {shelfLevels.map((y) => (
        <Box key={y} position={[0, y, 0]} scale={[2.02, 0.14, 0.78]} color="#4f6c5d" radius={0.025} />
      ))}
      ...
      <group name="studio-bookshelf-details">
        ...
        <mesh position={[-0.08, 1.86, 0.155]} rotation={[0, 0, 0.16]} castShadow receiveShadow>
